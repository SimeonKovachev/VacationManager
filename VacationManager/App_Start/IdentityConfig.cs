...
namespace VacationManager
{
    ...
    public class ApplicationUserManager : UserManager<VacationUser>
    {
        public ApplicationUserManager(IUserStore<VacationUser> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<VacationUser>(context.Get<VacationContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<VacationUser, string>
    {
